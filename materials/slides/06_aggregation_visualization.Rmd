...
subtitle: 'Lecture 6: Aggregation and Visualization I'
...
- Own research question, find a data set, think of approach/strategy, implement in R, presentation of results as Rmd/R-presentation recorded in a 'screencas'.
