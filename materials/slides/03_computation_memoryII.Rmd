...
- A large (>2GB) data set (of your choice).
  - Get inspired [here](https://www.kaggle.com/datasets?sizeStart=2%2CGB&sizeEnd=100%2CGB&page=6), [here](https://console.cloud.google.com/marketplace/browse?filter=solution-type:dataset), and [here](https://registry.opendata.aws/)
